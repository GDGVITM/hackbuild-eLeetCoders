...
export default function LandingPage() {
  ...
  const carouselImages = [
    ...
    {
      src: "/intramural-sports-mobile.png",
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-gradient-to-br from-white to-purple-50/30 rounded-xl shadow-sm border-0 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
            ...
            <Card className="bg-gradient-to-br from-white to-blue-50/30 rounded-xl shadow-sm border-0 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <CardContent className="p-8 text-center">
            ...
            <Card className="bg-gradient-to-br from-white to-green-50/30 rounded-xl shadow-sm border-0 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <CardContent className="p-8 text-center">
            ...
            <Card className="bg-gradient-to-br from-white to-orange-50/30 rounded-xl shadow-sm border-0 hover:shadow-xl hover:scale-105 transition-all duration-300 group">
              <CardContent className="p-8 text-center">
          ...
          <div className="text-center">
            <Link href="/browse-events">
              <Button
                size="lg"
                variant="outline"
                className="border-purple-600 text-purple-600 hover:bg-purple-50 rounded-lg px-8 py-3 bg-transparent"
              >
                View All Events
              </Button>
            </Link>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <div className="text-center">
              ...
              <Link href="/auth?form=signup&organize=true">
                <Button
                  size="lg"
                  variant="outline"
